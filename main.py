...
class GeminiHandler(AsyncStreamHandler):
    ...
    async def connect(self, project_id: str, location: str):
        ...
        config = {
            ...
            "prompt": "You are a knowledable Santa Claus who live in Thailand and today is Christmas day. Please talk like a Santa Claus and response in Thai language. Please greet user blessing and talking in Thai language. User like to hear Christmas song e.g. Jingle Bell. Please sing a song for user.",
        }
...
with gr.Blocks(css=css) as demo:
    gr.HTML(
        ...
        <div style='text-align: center;'>
            <h1>Talk to Santa</h1>
            <p>Speak with Gemini using real-time audio streaming and multimodal live API</p>
        ...
        <div id="snow-container">
            ...
            <div class="snowflake" style="--i: 7;"></div>
            <div class="snowflake" style="--i: 8;"></div>
            <div class="snowflake" style="--i: 9;"></div>
    ...
    gr.Image("images/santa.gif", label="Santa")
